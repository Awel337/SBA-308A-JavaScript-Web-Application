...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    (0, _uiJs.renderMatches)();
    (0, _uiJs.bindUIEvents)();
});

},{"./ui.js":"1hWqh"}],"1hWqh":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "renderPlayers", ()=>renderPlayers);
// Render head-to-head fixtures based on user-selected teams
parcelHelpers.export(exports, "renderHeadToHead", ()=>renderHeadToHead);
// Bind UI events for both player search and head-to-head search
parcelHelpers.export(exports, "bindUIEvents", ()=>bindUIEvents);
var _apiJs = require("./api.js");
async function renderMatches() {
    const matchList = document.getElementById('match-list');
    matchList.innerHTML = '<p>Loading upcoming matches...</p>';
    const matches = await (0, _apiJs.getUpcomingMatches)();
    if (!matches.length) {
    ...
    matches.forEach((match)=>{
        ...
        const scoreText = fullTimeScore.home !== null && fullTimeScore.away !== null ? `${fullTimeScore.home} - ${fullTimeScore.away}` : 'TBD';
        matchEl.innerHTML = `
...
async function renderPlayers(teamName) {
    const playerList = document.getElementById('player-list');
    playerList.innerHTML = '<p>Loading players...</p>';
    const playersData = await (0, _apiJs.searchPlayers)(teamName);
...
async function renderHeadToHead(team1Name, team2Name) {
    ...
    const team1Id = (0, _apiJs.teamNameToId)[team1Name];
    const team2Id = (0, _apiJs.teamNameToId)[team2Name];
    if (!team1Id || !team2Id) {
        headToHeadContainer.innerHTML = '<p>One or both team names are invalid. Please check your input.</p>';
        return;
    }
    const fixtures = await (0, _apiJs.getHeadToHeadFixtures)(team1Id, team2Id);
    if (!fixtures.length) {
...
function bindUIEvents() {
    ...
    searchBtn.addEventListener('click', ()=>{
        ...
        if (teamName) renderPlayers(teamName);
    });
    ...
    headToHeadBtn.addEventListener('click', ()=>{
        ...
        if (team1Name && team2Name) renderHeadToHead(team1Name, team2Name);
    });
}

},{"./api.js":"6yDOL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6yDOL":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "getUpcomingMatches", ()=>getUpcomingMatches);
parcelHelpers.export(exports, "teamNameToId", ()=>teamNameToId);
// Search for players by team name; converts team name to team ID
parcelHelpers.export(exports, "searchPlayers", ()=>searchPlayers);
// Fetch head-to-head fixtures using API-FOOTBALL for two teams (team1 and team2 IDs)
parcelHelpers.export(exports, "getHeadToHeadFixtures", ()=>getHeadToHeadFixtures);
...
async function getUpcomingMatches() {
    try {
        const response = await (0, _axiosDefault.default).get('https://api-football-v1.p.rapidapi.com/v3/fixtures', {
            params: {
                league: '39',
                season: '2023',
                next: '10'
...
async function searchPlayers(teamName) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get('https://api-football-v1.p.rapidapi.com/v3/players', {
            params: {
                team: teamId,
                season: '2023'
            },
...
async function getHeadToHeadFixtures(team1Id, team2Id) {
    try {
        const response = await (0, _axiosDefault.default).get('https://api-football-v1.p.rapidapi.com/v3/fixtures/headtohead', {
            params: {
                h2h: `${team1Id}-${team2Id}`
            },
            headers: RAPIDAPI_HEADERS
...
},{"a8d2c3349c87a903":"ktMON","./helpers/bind.js":"haRQb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ktMON":[function(require,module,exports,__globalThis) {
...
},{"adfd9b103875c2dd":"2Kymv","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Kymv":[function(require,module,exports,__globalThis) {
/*!
...
},{"8d7b0712b5ea2b3":"fypUa","603aed6e39afb648":"5Q1S4"}],"fypUa":[function(require,module,exports,__globalThis) {
'use strict';
...
},{}],"5Q1S4":[function(require,module,exports,__globalThis) {
